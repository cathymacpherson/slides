...
const STORAGE_KEY = "epc_2026_slide_state";
const CHANNEL_KEY = "epc_2026_slide_channel";
const MEDIA_STORAGE_KEY = "epc_2026_media_state";
...
function openPresenterView() {
  ...
  window.open(presenterUrl(), "epc_2026_presenter", `width=${width},height=${height},menubar=no,toolbar=no`);
}
